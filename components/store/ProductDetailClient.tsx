      ...
      <div className="relative rounded-2xl border-2 border-black bg-white p-6 shadow-xl">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2">
          {[
            ...
            { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", label: "7-day refund" },
        ...
        {product.comingSoon ? (
          ...
          <div className="mt-6 space-y-3">
            <PayButton
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-black px-5 py-3 text-sm font-bold text-white transition hover:bg-gray-800 active:scale-[0.97]"
            >
