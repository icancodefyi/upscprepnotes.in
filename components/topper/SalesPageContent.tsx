  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section id="toppers" className="border-b border-black/[0.04] bg-white py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-2 text-xl font-bold text-gray-900 sm:text-2xl">Starting at ₹99</h2>
            <p className="mt-2 text-sm text-gray-500">Instant download · 7-day refund guarantee.</p>
          </div>
      ...
      <section className="border-b border-black/[0.04] bg-gradient-to-b from-transparent via-emerald-50/30 to-transparent py-24 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-500">Offer</p>
            <h2 className="mt-3 text-2xl font-bold tracking-[-0.02em] text-gray-900 sm:text-3xl">Starting at ₹99</h2>
            <p className="mt-3 text-sm leading-relaxed text-gray-500">Instant download · 7-day refund guarantee.</p>
          </div>
          <div className="mx-auto mt-10 max-w-lg">
            <div className="rounded-2xl border-2 border-emerald-200 bg-white p-6 shadow-[0_4px_24px_-12px_rgba(0,0,0,0.1)] sm:p-8">
              <div className="text-center">
                <span className="inline-block rounded-full bg-emerald-500 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-white">Offer</span>
                ...
                <p className="mt-1 text-xs text-gray-400">Starting at ₹99 · Instant download</p>
              </div>
              ...
              <div className="mt-5 flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
                ...
                <span className="flex items-center gap-1 text-xs text-gray-400"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>Starting at ₹99</span>
