    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-md rounded-2xl bg-white shadow-2xl p-6 sm:p-8">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-4 text-lg font-bold text-gray-900">Special Offer!</h2>
          <p className="mt-2 text-sm text-gray-500 leading-relaxed">
            Starting at <strong className="text-emerald-300">₹99</strong> · Instant download.
          </p>
        </div>

        <div className="mt-6 rounded-xl bg-gradient-to-br from-zinc-900 via-black to-zinc-900 p-4 text-center">
          <p className="text-xs text-emerald-400 font-semibold uppercase tracking-wider">Offer</p>
