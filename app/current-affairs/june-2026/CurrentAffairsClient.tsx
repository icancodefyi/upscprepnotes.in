        ...
        <div className="mt-16 space-y-4">
          ...
          <div className="rounded-xl p-6 sm:p-8 text-center" style={{ backgroundColor: SURFACE, border: `1px solid ${HAIRLINE}` }}>
            ...
            <div className="mt-3 flex flex-wrap justify-center gap-2">
              <Link href="/current-affairs/may-2026" className="text-[13px] font-medium underline-offset-4 hover:underline" style={{ color: INK_MUTED }}>May 2026 Edition</Link>
              ...
              <span style={{ color: INK_FAINT }}>·</span>
              <Link href="/api/generate-current-affairs?month=june-2026" className="text-[13px] font-medium underline-offset-4 hover:underline" style={{ color: INK_MUTED }}>Download PDF</Link>
            </div>
          </div>
        </div>
      </div>
