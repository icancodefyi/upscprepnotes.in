...
const SUBJECT_DATA: Record<string, SubjectInfo> = {
  ...
  history: {
    name: "History",
    description: "History optional: ancient, medieval, modern India and world history — a classic choice for aspirants with strong analytical and chronological skills.",
    overview: "History as a UPSC optional is divided into two papers: Paper I covers ancient and medieval Indian history (pre-history, Indus Valley, Vedic period, Mauryan, Gupta, Delhi Sultanate, Mughals, and regional kingdoms) along with world history (Renaissance, Enlightenment, Industrial Revolution, world wars). Paper II focuses on modern Indian history from the mid-18th century to independence — British expansion, economic impact, socio-religious reform movements, national movement, and partition. History requires strong chronological understanding, analytical writing, and the ability to connect events across periods. Candidates who enjoy structured narratives, causal analysis, and debate find History a rewarding optional.",
    whyPopular: "History remains one of the most opted UPSC optional subjects despite its vast syllabus. Its popularity stems from substantial overlap with GS I (Indian heritage, culture, history, society) and GS II (governance, constitution — through modern Indian history). The subject offers abundant standard textbooks (Bipan Chandra, Satish Chandra, Romila Thapar), predictable question patterns, and rich material for the essay paper. History optional candidates often outperform because their training in causal analysis and source evaluation directly translates to superior GS answers.",
    booklist: [
      ...
      "R.C. Majumdar — The History and Culture of the Indian People (select volumes)",
    ...
    syllabusTopics: [
      "Pre-history and proto-history: Palaeolithic, Mesolithic, Neolithic, Indus Valley Civilization",
      "Vedic and later Vedic period: society, economy, religion, polity",
      "Mauryan and post-Mauryan: state, administration, economy, art and architecture",
      "Gupta and post-Gupta: classical age, feudalism, cultural developments",
      "Early medieval India: Rajput kingdoms, Cholas, Bhakti movement",
      "Delhi Sultanate: political structures, economy, society, architecture",
      "Mughal Empire: administration, economy, culture, decline",
      "Modern India: British expansion, economic policies, social reform movements",
      "National movement: 1857 revolt, Congress, Gandhian phase, Partition",
      "World history: Renaissance, Reformation, Industrial Revolution, World Wars",
    ],
    prepInsights: [
      "Build a strong chronological framework first — map every period with key events, rulers, and socio-economic conditions.",
      "Focus on themes and debates rather than isolated facts. UPSC asks analytical questions, not rote recall.",
      "Master the art of writing balanced answers — present multiple historiographical perspectives (nationalist, Marxist, subaltern).",
      "For modern India, connect historical events to contemporary issues — land reforms to Naxalism, communal politics to secularism debates.",
      "Practice previous year questions — History has a predictable pattern with repeated themes across decades.",
      "Use maps extensively for ancient and medieval periods — locate kingdoms, trade routes, and archaeological sites.",
    ],
