          ...
          <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl">
            ...
            >
              ...
              <p className="mt-3 text-center text-xs text-zinc-400">
                Already signed in? <Link href="/store" className="text-zinc-500 underline underline-offset-2 decoration-zinc-300 hover:decoration-zinc-500">Browse premium resources</Link>
              </p>
          </div>
        </div>
      )}
          ...
          <div className="mx-auto max-w-[720px] px-4">
            ...
            {quota && (
              <p className="mt-1.5 text-center text-[11px] text-zinc-400">
                ...
                {quota.remaining <= 1 && quota.isAuthenticated && (
                  <> — <Link href="/store" className="text-zinc-500 underline underline-offset-2 decoration-zinc-300 hover:decoration-zinc-500">Browse premium resources</Link></>
                )}
              </p>
            )}
          </div>
