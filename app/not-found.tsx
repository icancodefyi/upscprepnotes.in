...
export const metadata: Metadata = {
  title: "Page Not Found — UPSCPrepNotes",
  description: "The page you're looking for doesn't exist. Browse UPSC toppers, answer copies, marksheets, and preparation resources.",
