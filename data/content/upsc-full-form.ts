  ...
  faq: [
    {
      ...
      a: "The full form of UPSC is Union Public Service Commission. In Hindi, it is known as संघ लोक सेवा आयोग.",
    },
    {
      q: "Is UPSC a constitutional body?",
      a: "Yes, UPSC is a constitutional body established under Article 315 of the Constitution of India.",
    },
    {
      q: "What is the difference between UPSC and SPSC?",
      a: "UPSC (Union Public Service Commission) is the central recruiting agency for the Union Government, while SPSC (State Public Service Commission) handles recruitment for state government services.",
    },
    {
      q: "Who is the current chairman of UPSC?",
      a: "As of 2025–26, Dr. Manoj Soni is the Chairman of the Union Public Service Commission.",
    },
    {
      q: "How many exams does UPSC conduct every year?",
      a: "UPSC conducts around 14–16 exams every year, including the Civil Services Examination (CSE), Engineering Services (ESE), CDS, NDA, CMS, and CAPF, among others.",
    },
    {
