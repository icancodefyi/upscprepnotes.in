...
const page: ContentPage = {
  ...
  sections: [
    {
      heading: "UPSC Prelims Syllabus — Paper I (General Studies)",
      body: `The Prelims consists of two papers, both objective type (MCQs). Paper I is for merit ranking; Paper II (CSAT) is qualifying only.
...
The trick with Prelims is not to read everything — it's to **eliminate options** smartly. Most toppers rely on mock tests and PYQ analysis rather than exhaustive reading.`,
    ...
    {
      heading: "UPSC Prelims Syllabus — Paper II (CSAT)",
      body: `**Paper II — Civil Services Aptitude Test (CSAT, 200 marks, 2 hours)**
...
CSAT is often underestimated. While it's qualifying, a tough paper can waste your year. Practice 10-15 previous years' papers to build speed.`,
    ...
    {
      heading: "UPSC Mains Syllabus — Complete Paper-wise Breakdown",
      body: `The Mains has 9 papers, totalling 1,750 marks. Only 7 papers count for ranking (Paper I–VII). Papers A and B are qualifying.
...
This is where most preparation time goes — the Mains syllabus is vast but well-structured. Successful candidates break it down into micro-topics and use **PYQ trend analysis** to identify high-weightage areas.`,
    ...
    {
      heading: "How to Use the UPSC Syllabus as Your Study Plan",
      body: `Most aspirants make the same mistake — they print the syllabus, read it once, and never look at it again. Here's how toppers actually use it:
...
Together, the syllabus + PYQs + topper answer copies form the most powerful combination for UPSC preparation.`,
    ...
    {
      heading: "UPSC Optional Subject Syllabus",
      body: `The optional subject contributes 500 marks (2 papers) to your final score — making it one of the most rank-deciding factors.
...
Each optional has a specific syllabus published by UPSC. Download the optional syllabus for your chosen subject and create a study plan around it. The same **PYQ cross-referencing** technique applies here too.`,
    ...
    {
      heading: "UPSC Personality Test (Interview) — What to Expect",
      body: `The Interview (Personality Test) carries **275 marks** and is conducted by the UPSC board. Unlike the written exam, there's no fixed syllabus, but questions generally cover:
...
Preparation for the interview requires mock sessions, current affairs revision, and deep self-awareness. Many toppers prepare 100+ likely questions from their DAF before the interview.`,
    ...
    {
      heading: "UPSC Syllabus PDF Downloads & Resources",
      body: `While you can download the official syllabus from **upsc.gov.in**, the real challenge is turning that syllabus into a preparation strategy.
...
The **Complete Compilation** includes strategy guides mapped to every syllabus section, plus actual answer copies showing you exactly how to structure answers within the UPSC evaluation framework.`,
  ...
  faq: [
    {
      q: "Where can I download the official UPSC syllabus PDF?",
      a: "The official UPSC syllabus PDF is available on upsc.gov.in. However, a plain PDF isn't enough — you need PYQ trend analysis and answer writing practice to use it effectively.",
    },
    {
      q: "How many papers are there in UPSC Mains?",
      a: "UPSC Mains has 9 papers — 2 qualifying (Language + English) and 7 merit-based (Essay, 4 GS papers, 2 Optional papers). Total marks: 1,750 for ranking, plus 275 for Interview = 2,025 total.",
    },
    {
      q: "Is CSAT part of the UPSC syllabus?",
      a: "Yes, CSAT is Paper II of Prelims. It tests comprehension, logical reasoning, numeracy, and data interpretation. It's qualifying at 33% — you just need to pass, not score high.",
    },
    {
      q: "Which optional subject has the shortest syllabus?",
      a: "Anthropology, Sociology, and Philosophy are generally considered to have more compact syllabi. However, the best optional is one that aligns with your strengths and has good overlap with GS papers.",
    },
    {
      q: "How do I know which topics are important in the UPSC syllabus?",
      a: "Cross-reference each syllabus point with PYQs from the last 10-15 years. Topics that appear repeatedly (like Constitution, Environment, Current Affairs) deserve more attention. This analysis saves months of wasted effort.",
    },
  ],
};
